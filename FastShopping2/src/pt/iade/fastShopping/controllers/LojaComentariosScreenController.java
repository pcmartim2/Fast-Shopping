...
public class LojaComentariosScreenController {
	...
	private void initialize() {
		...
		DBConnector.getComentariosLoja(MapaScreenController.idLoja, comentarioList);
	...
	void enviarComentario(ActionEvent event) {
		...
		if (!textAreaComentario.getText().isEmpty()) {
			...
			DBConnector.addComentario(textAreaComentario.getText(), MapaScreenController.idLoja, LoginUtilizadorController.IdUser);
