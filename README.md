...
##### Enquadramento (melhorar muito curto):
...
Cenário secundário(remover): O utilizador ser capaz de cria uma conta e usá-la para entrar na aplicação;

Cenário secundário(dividir em dois cenários secundaários): O utilizador ser capaz de deixar comentários ou feedback nas lojas/supermercados escolhidos e adicioná-las ou
removê-las aos favoritos ;

Cenário secundário(remover): Possibilidade de adicionar uma nova localidade de uma loja (só possível com uma conta de gestor da loja/mercado); 
